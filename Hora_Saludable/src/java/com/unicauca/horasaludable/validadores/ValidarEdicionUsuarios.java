...
public class ValidarEdicionUsuarios implements Serializable {
    ...
    public boolean validarGenero(Character genero) {
        if (!(genero.toString().equals("M") || genero.toString().equals("F"))) {
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Campo sexo solo puede ser M o F.", "Campo sexo solo puede contener M o F."));
            return false;
        }
